...
const GeneralNews = ({ language, startDate, endDate, setFetchedNews, fetchedNews }) => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        ...
        // Update the fetched news in the parent component
            ...
            <li key={index} style={{ marginBottom: "20px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start" }}>
                <div style={{ flex: 1 }}>
                  ...
                  <p>
                    {article.source.name}, {formatDate(article.publishedAt, language)}
                  </p>
                </div>
                {article.urlToImage && (
                  <img
